...
function [b12H,b12L,OF1L,OF1H,c1,c2,C0,x1,OF2,B02OPT,B01OPT] = tenedor(alpha, delta,nu,tau,gr,BU,psi,ph)
...
figure(1)
plot (B,OF1L{1,1}(1,:), B,OF1L{1,1}(:,1)), legend('OF1L for min B01 and min B12','OF1L for min B01 and min B02');

figure(2)
plot (B,OF1H{1,1}(1,:), B,OF1H{1,1}(:,1)), legend('OF1H for min B01 and min B12','OF1H for min B01 and min B02');
end